...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex justify-content-between">
            ...
            <a href="{{ route('instructor_courses_form') }}" class="btn bg-primary text-light pointer">ADD COURSE</a>
        </div>
        <div class="card-body">
                    ...
                    <tbody>
                        @foreach ($course as $key => $value)
                            <tr>
                                ...
                                <td>{{ $value->title }}</td>
                                <td><img src="{{ asset('uploads') . '/' . $value->image }}" alt="" width="50" height="50"></td>
