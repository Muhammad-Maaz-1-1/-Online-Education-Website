...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item {{ request()->routeIs('student_dashboard') ? 'active' : '' }}  ">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item {{ request()->routeIs('student_courses') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('student_courses') }}">
                    <i class="fas fa-fw fa-table"></i>
                    <span>All courses</span></a>
            </li>
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item {{ request()->routeIs('dashboard') ? 'active' : '' }}  dropdown no-arrow">
